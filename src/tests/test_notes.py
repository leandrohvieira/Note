...
def test_read_all_notes(test_app, monkeypatch):
    test_data = [
        {"title": "something", "description": "sommething else", "id": 1},
        {"title": "something", "description": "sommething else", "id": 2},
    ]

    async def mmock_get_all():
        return test_data

    monkeypatch.setattr(crud, "get_all", mmock_get_all)
